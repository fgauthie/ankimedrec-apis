...
module.exports = function (app) {
    ...
    function secure_find(req, res, collection, query, projection, cb) {
	...
	if(hasPayload) {
	    ...
	    console.log("Found some bad chars!!!");
            msg = {
		formatted_body: "<strong>Alert!</strong> Someone is trying to break into your app: <a href=\"https://140.86.12.67:3000\">anki-medrec.oracleau.cloud</a>",
    ...
    app.get('/patients', function (req, res) {
        ...
        secure_find(req, res, collection,q, {}, function (e, docs) {
    ...
    app.get('/patients/:PatientId', function (req, res) {
        ...
        secure_find(req, res, collection,{ "_id": id }, {}, function (e, docs) {
    ...
    app.get('/patients/:PatientId/consultations', function (req, res) {
        ...
        secure_find(req, res, collection,{ "PatientId": id }, {}, function (e, docs) {
